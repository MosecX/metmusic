...
export default function Sidebar() {
  return (
    <aside className="glass slide-in-left fixed inset-y-0 left-0 z-30 hidden w-60 flex-col border-r border-white/10 p-4 pb-[calc(6.5rem+env(safe-area-inset-bottom))] lg:flex">
